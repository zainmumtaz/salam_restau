      ...
      if (response.statusCode == 200) {
        ...
        //  await loadpayoutmenmethods();
          ...
          if (responseData['data']['user']['info'] != null) {
            ...
            if (csavedPath != null) {
              print('QR Image saved at: $csavedPath');
              await SharedPref.saveCodeImagePath(csavedPath);
            } else {
              print('QR Image could not be saved');
            }

            if (usavedPath != null) {
              print('User Image saved at: $usavedPath');
              await SharedPref.saveProfileImagePath(usavedPath);
            } else {
              print('User Image could not be saved');
            }
          }
          print("home direction done ");
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData['success'] == true && responseData['data'] is List) {
          ...
          print("✅ Payment methods saved to SharedPref");
        } else {
      ...
      print("❌ Exception in loadPaymentMethod: $e");
      SnackbarUtils.showError("$e");
    }
  }
